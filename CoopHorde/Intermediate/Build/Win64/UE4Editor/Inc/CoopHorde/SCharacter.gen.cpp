...
#include "CoopHorde/Public/SCharacter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	COOPHORDE_API UClass* Z_Construct_UClass_ASCharacter_NoRegister();
	COOPHORDE_API UClass* Z_Construct_UClass_ASCharacter();
	ENGINE_API UClass* Z_Construct_UClass_ACharacter();
	UPackage* Z_Construct_UPackage__Script_CoopHorde();
...
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_ASCharacter_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_CoopHorde,
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASCharacter_Statics::NewProp_SpringArmComponent = { UE4CodeGen_Private::EPropertyClass::Object, "SpringArmComponent", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x00200800000a001d, 1, nullptr, STRUCT_OFFSET(ASCharacter, SpringArmComponent), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASCharacter_Statics::NewProp_SpringArmComponent_MetaData, ARRAY_COUNT(Z_Construct_UClass_ASCharacter_Statics::NewProp_SpringArmComponent_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ASCharacter, 3314179447);
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASCharacter(Z_Construct_UClass_ASCharacter, &ASCharacter::StaticClass, TEXT("/Script/CoopHorde"), TEXT("ASCharacter"), false, nullptr, nullptr, nullptr);
